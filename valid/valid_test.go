...
func TestValid(t *testing.T) {
	...
	check(IsNumber("12345", 6), true)
	check(IsNumber("12345", 6, 0), true)
	check(IsNumber("12345", 0, 6), true)
	check(IsNumber("12345", 2, 6), true)
	check(IsNumber("12345", 2, 4), false)
	check(IsNumber("12345", 5, 5), true)
	check(IsNumber("12345", 6, 6), false)
	check(IsNumber("123456", 6, 6), true)
